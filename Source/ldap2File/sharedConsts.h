...
// Retours
enum class RET_TYPE {RET_OK = 0, RET_INVALID_FILE, RET_INVALID_PARAMETERS, RET_ERROR_NO_DESTINATION, RET_BLOCKING_ERROR,RET_NON_BLOCKING_ERROR,RET_LDAP_ERROR,RET_UNABLE_TO_SAVE, RET_FILE_TO_DELETE, RET_NO_SUCH_CONTAINER_ERROR, RET_INVALID_OUTPUT_FORMAT, RET_ERROR_NO_CONTAINER };
